...
import type { AboutSectionInput, SiteProfile } from "../../types";
...
export function AdminAboutArtist() {
  ...
  const [form, setForm] = useState<AboutSectionInput | null>(null);
  ...
  const save = useMutation({
    mutationFn: async () => {
      ...
      return api.patch<SiteProfile>("/v1/site-profile/about", payload);
    },
    onSuccess: (updated) => {
      if (!updated) return;
